            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Daftar Surat Keterangan Kematian</h4>
                        <a href="{{ route('exportKematian') }}" class="btn btn-primary btn-sm mb-2">Export Surat</a>
                            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('pdfKematian', [$data->id]) }}" class="btn btn-primary"><i class="fa fa-user"> Print</i></a>
                                        </td>
