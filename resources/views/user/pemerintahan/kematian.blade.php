...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
<div class="card-body">
    <h4 class="card-title">Surat Keterangan Kematian</h4>
    <form action="{{ route('buat.kematian') }}" method="POST">
        @csrf
    ...
    <div class="form-group">
                ...
                <input type="text" class="form-control" name="keterangan" value="{{ $user->penduduk->keterangan }}" placeholder="Contoh : Rabu, tanggal 24 Maret 2020 Jam 04.00 di Rumah Karena Sakit">
